...
# fixed intersect for only part 1
# this is the printed version - first untangle algorithm is fast,
# then apply permutations to make distance shorter, then use better untangle algorithm
