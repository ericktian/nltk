...
# untangle
# current flipping alg doenst work
...
edgeD = []
for i in range(len(nodesDict)-1):
    edgeD.append([i,i+1])
...
for i in newEdgeD:
    G.add_edge(i[0],i[1])
    totaldistance += calcd(nodesDict[i[0]][1],nodesDict[i[0]][0],nodesDict[i[1]][1],nodesDict[i[1]][0])
print(totaldistance, "km")

G.add_edge(len(nodesDict)-1,0)
